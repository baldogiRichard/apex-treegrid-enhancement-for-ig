...
(function($) {
    ...
    var methods = {
        ...
        initNode: function(settings) {
            return this.each(function() {
                ...
                $this.treegrid('initEvents').treegrid('initExpander').treegrid('initIndent').treegrid('initState').treegrid('initChangeEvent').treegrid("initSettingsEvents");
            });
        },
        ...
        initEvents: function() {
            ...
            $this.on("collapse", function() {
                var $this = $(this);
                $this.removeClass('apex-treegrid-expanded');
                $this.addClass('apex-treegrid-collapsed');
            });
            //Default behavior on expand
            $this.on("expand", function() {
                var $this = $(this);
                $this.removeClass('apex-treegrid-collapsed');
                $this.addClass('apex-treegrid-expanded');
            });
         ...
         * @returns {Node}
         */
        initIndent: function(pDepthLevel) {
            var $this = $(this);
            var expander = $this.find('.apex-treegrid-expander');
            $(expander).css({"margin-left":pDepthLevel*expander.width()}); 
            return $this;
        },
        /**
         ...
         */
        isExpanded: function() {
            return $(this).hasClass('apex-treegrid-expanded');
        },
        /**
        ...
        isCollapsed: function() {
            return $(this).hasClass('apex-treegrid-collapsed');
        },
        /**
    ...
    $.fn.treegrid.defaults = {
        ...
        expanderTemplate: '<span class="apex-treegrid-expander"></span>',
        indentTemplate: '<span class="apex-treegrid-indent"></span>',
        expanderExpandedClass: 'apex-treegrid-expander-expanded',
        expanderCollapsedClass: 'apex-treegrid-expander-collapsed',
        treeColumn: 0,
        getExpander: function() {
            return $(this).find('.apex-treegrid-expander');
        },
        getNodeId: function() {
            var template = /apex-treegrid-([A-Za-z0-9_-]+)/;
        ...
        getParentNodeId: function() {
            var template = /apex-treegrid-parent-([A-Za-z0-9_-]+)/;
            var templateTest = template.test($(this).attr('class'));

            if (templateTest && $('.apex-treegrid-' + template.exec($(this).attr('class'))[1]).length) {
                return template.exec($(this).attr('class'))[1];
            }
            return null;
        },
        getNodeById: function(id, treegridContainer) {
            var templateClass = "apex-treegrid-" + id;
            return treegridContainer.find('tr.' + templateClass);
        },
        getChildNodes: function(id, treegridContainer) {
            var templateClass = "apex-treegrid-parent-" + id;
            return treegridContainer.find('tr.' + templateClass);
        },
        ...
        getRootNodes: function(treegridContainer) {
            var result = $.grep(treegridContainer.find('tr'), function(element) {
                ...
                var templateClass = /apex-treegrid-([A-Za-z0-9_-]+)/;
                var templateParentClass = /apex-treegrid-parent-([A-Za-z0-9_-]+)/;
